...
// Modal konfirmasi sebelum sign-out. Murni presentasional, tidak menyentuh
// Supabase sama sekali — pemanggil (page.jsx) yang mengurus signOut().
//
// Props:
// - onConfirm(): dipanggil saat "Ya, keluar" diklik
// - onClose(): dipanggil saat "Batal" diklik
export default function SignOutConfirmModal({ onConfirm, onClose }) {
  return (
